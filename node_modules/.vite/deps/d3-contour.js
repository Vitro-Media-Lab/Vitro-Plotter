...
function contours_default() {
	...
	function contours(values) {
		...
		} else tz = tz.slice().sort(ascending_default);
	...
	function contour(values, value) {
		...
		holes.forEach(function(hole) {
			for (var i = 0, n = polygons.length, polygon; i < n; ++i) if (contains_default((polygon = polygons[i])[0], hole) !== -1) {
				polygon.push(hole);
				return;
			}
		});
...
//#endregion
export { density_default as contourDensity, contours_default as contours };

//# sourceMappingURL=d3-contour.js.map